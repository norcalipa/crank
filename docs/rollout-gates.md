...
fail if a registered key is missing from the drill.
...
| Assistant shell | `assistant_shell` | #471 | off | planned |
| Recompute phases | per-phase key (named at implementation) | #462 | off | planned |
